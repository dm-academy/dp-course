...
`$ docker run -d -p 8081:30100 gcr.io/<your Google ID>/node-svc:latest
...
1)  enable the appropriate APIs but NOT continue to "Go to Credentials." Go back to https://github.com/google-github-actions/setup-gcloud/tree/master/example-workflows/gke[this page].
