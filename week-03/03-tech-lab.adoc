...
Actual  (replace <yourGoogleID> with your own yourGoogleID, and <your Google Project> with your Google project). We also as the actual tag are going to indicate v1, for "version 1":

[source,bash]
----
$ docker tag <yourGoogleID>/node-svc us.gcr.io/<your Google Project>/node-svc:v1
$ docker push us.gcr.io/<your Google Project>/node-svc:v1
----
