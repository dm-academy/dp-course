...
Push the updated server.js file to your Github repository. This should kick off the pipeline and result in your Kubernetes cluster being automatically updated with the new file. 
