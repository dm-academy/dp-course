...
In other words, I am operating first as "CharlesTBetz-test" which is a Github account I creaated that has no more rights than any of you. Acting as such, I have forked the master dm-academy/node-svc repo and cloned it down to my Google Cloud Shell. 
