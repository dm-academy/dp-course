...
The problem with this approach is that it is not particularly convenient to pull updates from upstream into our local repo. 

There are two ways we can solve this. 

1. You can pull changes in by running compares on Github and then pulling the changes down. This is cumbersome. 
