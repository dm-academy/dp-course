...
Check your work against https://github.com/dm-academy/dp-course/blob/master/week-02/02-lab.adoc.


=== Option 2 - easier

Go tohttps://github.com/dm-academy/dp-course/blob/master/week-02/02-lab.adoc and review what you find there. Either copy the contents as needed into your own local files, or clone it directly, review, and run `terraform apply`. 
