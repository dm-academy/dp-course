...
Prove your work by issuing a URL of /20 or above to the microservice on either machine and posting a screen shot of the output to the Canvas assignment.
